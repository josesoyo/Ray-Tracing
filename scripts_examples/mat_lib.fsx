...
let mout = [|{MatName= "Mirror"; R=1.; T=0.;
               ...
               {MatName= "BeamSplitter"; R=0.5; T=0.5;
                ...
                {MatName= "BK7_T"; R=0.001; T=0.999;                               //    
                    n=(1.50669,WaveLength(1.06e-6 |> LanguagePrimitives.FloatWithMeasure<m>));LambPPM= 0.};
               
                {MatName= "Aluminium"; R=0.71; T=0.0;                               //  Transmission is 0% for thickness thicker than fractions of mm  
